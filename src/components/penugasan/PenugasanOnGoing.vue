  ...
  <div>
    <div class="mb-4 mt-4">
      <h1 class="text-sm font-semibold text-gray-600 mb-2">
        ...
        <span class="text-gray-500"> Daftar Penugasan Belum Selesai</span>
      </h1>
      <hr />
    </div>
    <div class="card border-0 shadow">
      <div class="card-body flex flex-col">
        <h5 class="text-ld text-gray-800 mb-3 font-semibold">
          Daftar Penugasan Belum Selesai
        </h5>
        <VueyeTable
          :data="daftarTugas2"
          :columns="columns"
...
export default {
  ...
  methods: {
    ...mapActions(["fetchTugasOnGoing", "deleteTugas"]),
  },
  computed: mapGetters(["daftarTugas2"]),
  created() {
    document.title = "Penugasan Pegawai Belum Selesai";
    this.fetchTugasOnGoing();
  },
};
</script>